    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div id="modal-body" class="modal-body">
            ...
            <div>
                <h4>Choose a new Temperature</h4><input id="tempNew" data-slider-id='tempSlider' type="text" data-slider-min="9" data-slider-max="30" data-slider-step="1" data-slider-value="15"/>        
            </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div id="modal-body" class="modal-body">
            ...
            <div>
            <p>Temperature</p><input id="tempPrefEdit" data-slider-id='tempEditSlider' type="text" data-slider-min="9" data-slider-max="30" data-slider-step="1" data-slider-value="15"/>        
        </div>
            <div>
